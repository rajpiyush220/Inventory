function sortChanged(selectedColumn){
    ...
    location.href = build_sort_url('audit/list',currentPageSize,currentPageNumber,sortOrder,sortColumn,searchKey,searchType);
}
...
function clearDataFilter(){
    location.href = build_sort_url('audit/list',0,0,'','','','');
}
